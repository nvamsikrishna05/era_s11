...
`resnet.py` file contains the CNN Model. It has `ResNet18` model
...
![Incorrect Predictions](<CleanShot 2023-07-28 at 10.05.04@2x.png>)


Grad-CAM of Incorrect Predictions
![GradCam of Incorrect Predictions](<CleanShot 2023-07-28 at 10.05.39@2x.png>)